...
class RideForm(forms.ModelForm):
    class Meta:
        ...
        fields = (
            ...
            "monday_arriving_at_time",
            "tuesday_check",
            "tuesday_leaving_at_time",
            "tuesday_arriving_at_time",
            "wednesday_check",
            "wednesday_leaving_at_time",
            "wednesday_arriving_at_time",
            "thursday_check",
            "thursday_leaving_at_time",
            "thursday_arriving_at_time",
            "friday_check",
            "friday_leaving_at_time",
            "friday_arriving_at_time",
            "saturday_check",
            "saturday_leaving_at_time",
            "saturday_arriving_at_time",
            "sunday_check",
            "sunday_leaving_at_time",
            "sunday_arriving_at_time",
            "note",
            # "test",
            # "private",
        )